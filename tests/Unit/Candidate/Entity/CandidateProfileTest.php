...
final class CandidateProfileTest extends TestCase
{
    ...
    public function testItCanUpdateDetailsAndSynchronizeActiveCv(): void
    {
        ...
        $profile->updateDetails('  Lead Developer  ', '  Lyon et périphérie  ', 7, ['FREELANCE', 'CDI'], 60000, 600, \App\Candidate\Enum\RemotePolicy::REMOTE, ['Capgemini', 'Alten'], ['WordPress', 'Prestashop']);
        ...
        self::assertSame(\App\Candidate\Enum\RemotePolicy::REMOTE, $profile->getPreferredRemotePolicy());
        self::assertSame(['Capgemini', 'Alten'], $profile->getExcludedCompanies());
        self::assertSame(['WordPress', 'Prestashop'], $profile->getExcludedKeywords());
        ...
        $profile->updateDetails('', '   ', null, [], null, null, \App\Candidate\Enum\RemotePolicy::UNKNOWN, [], []);
        ...
        self::assertSame(\App\Candidate\Enum\RemotePolicy::UNKNOWN, $profile->getPreferredRemotePolicy());
        self::assertSame([], $profile->getExcludedCompanies());
        self::assertSame([], $profile->getExcludedKeywords());
