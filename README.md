...
La validation présente les compétences détectées sous forme de cartes avec leur catégorie et leur niveau proposé. Après application, la section **Mes compétences** du profil permet d'ajouter une compétence manuellement, de modifier plusieurs niveaux puis de les enregistrer en une fois grâce à une barre d’action persistante, ou de supprimer une compétence.
