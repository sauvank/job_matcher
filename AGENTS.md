# Instructions de travail — Job Matcher

- Lire `PROJECT_CONTEXT.local.md` au début de chaque session lorsqu'il existe, puis le tenir à jour sans y placer de secret.
